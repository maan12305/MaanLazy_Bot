...
DATABASE_NAME = environ.get('DATABASE_NAME', "techvjbotz)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
LAZY_GROUP_LOGS = int(environ.get('LAZY_GROUP_LOGS', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/clxxoxpxp')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "False")), False)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "False")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⍟ File Name🔻</b>\n\n{file_name}</a></b>\n\n<b>**⍟  File Size\n\n  🔻[ {file_size} ]</a></b>**")
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','Im_professor_22') # WITHOUT @
...
URL_SHORTENR_WEBSITE = environ.get('URL_SHORTENR_WEBSITE', 'tryshort.in') #Always use website url from api section 
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', 'e02fb0028bd6ec39e18a59f11b09474a31ce980c')
...
OWNER_USERNAME = "Im_professor_22"
...
DOWNLOAD_TEXT_URL = "https://t.me/howtoopin"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/movie_update_channel0"
